...
test('the application returns a successful response', function () {
    ...
    $response
        ...
        ->assertSee('rel="icon" type="image/png" href="http://notdone.test/favicon.png" media="(prefers-color-scheme: light)"', false)
        ->assertSee('rel="icon" type="image/png" href="http://notdone.test/favicon-dm.png" media="(prefers-color-scheme: dark)"', false)
        ->assertSee('rel="apple-touch-icon" href="http://notdone.test/favicon.png"', false)
        ->assertSee('rel="mask-icon" href="http://notdone.test/images/logo.svg" color="#e4572e"', false)

...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630" role="img" aria-label="{$escapedTitle}">
    <rect width="1200" height="630" fill="#fff7f7"/>
    <rect width="1200" height="630" fill="#fde7e8" opacity="0.42"/>
    <circle cx="1020" cy="150" r="118" fill="#ec2024" opacity="0.12"/>
    <circle cx="1100" cy="515" r="168" fill="#ec2024" opacity="0.08"/>
    {$logoSvg}
    ...
    <rect x="88" y="520" width="180" height="8" rx="4" fill="#ec2024"/>
</svg>
SVG;
    ...
    private function logoSvg(): string
    {
        ...
        if (! is_file($path)) {
            return '<text x="88" y="142" fill="#0b0b0b" font-family="Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \'Segoe UI\', sans-serif" font-size="42" font-weight="800" letter-spacing="1.5">NOT<tspan fill="#ec2024">DONE</tspan></text>';
        }
